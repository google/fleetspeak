...
// Package channel provides simple fleetspeak.Message passing over interprocess
// pipes.
//
// TODO: find a better place for this, it is used by daemonserver,
// socketserve and their respective go client libraries. Therefore the package
// should be in a more general location.
package channel
