...
func (m *ByteBlob) XXX_DiscardUnknown() {
	xxx_messageInfo_ByteBlob.DiscardUnknown(m)
}

var xxx_messageInfo_ByteBlob proto.InternalMessageInfo
...
func (m *APIMessage) GetData() *any.Any {
	if m != nil {
		return m.Data
	}
	return nil
