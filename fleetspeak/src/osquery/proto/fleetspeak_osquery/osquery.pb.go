...
/*
Package fleetspeak_osquery is a generated protocol buffer package.

It is generated from these files:
	fleetspeak/src/osquery/proto/fleetspeak_osquery/osquery.proto
...
func (LoggedResult_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
type LoggedResult struct {
	Type     LoggedResult_Type `protobuf:"varint,1,opt,name=type,enum=fleetspeak.osquery.LoggedResult_Type" json:"type,omitempty"`
	Compress CompressionType   `protobuf:"varint,2,opt,name=compress,enum=fleetspeak.osquery.CompressionType" json:"compress,omitempty"`
...
func (*LoggedResult) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
type Queries struct {
	...
	Queries map[string]string `protobuf:"bytes,1,rep,name=queries" json:"queries,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	// a result.
	Discovery map[string]string `protobuf:"bytes,2,rep,name=discovery" json:"discovery,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *Queries) Reset()                    { *m = Queries{} }
func (m *Queries) String() string            { return proto.CompactTextString(m) }
func (*Queries) ProtoMessage()               {}
func (*Queries) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type Row struct {
	Row map[string]string `protobuf:"bytes,1,rep,name=row" json:"row,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*Rows) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
type QueryResults struct {
	...
	Compress CompressionType `protobuf:"varint,3,opt,name=compress,enum=fleetspeak.osquery.CompressionType" json:"compress,omitempty"`
...
func (*QueryResults) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func init() {
	proto.RegisterFile("fleetspeak/src/osquery/proto/fleetspeak_osquery/osquery.proto", fileDescriptor0)
}
