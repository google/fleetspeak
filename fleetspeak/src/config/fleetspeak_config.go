...
var configFile = flag.String("config", "", "Configuration file to read. Should contain a text format fleetspeak.config.Config protocol buffer. See /etc/fleetspeak-server/configuration.config as a starting point.")
