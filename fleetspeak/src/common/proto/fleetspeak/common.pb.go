...
type ContactData struct {
	...
	// will be sent.
	DoneSending bool `protobuf:"varint,5,opt,name=done_sending,json=doneSending" json:"done_sending,omitempty"`
	...
	AllowedMessages map[string]uint64 `protobuf:"bytes,6,rep,name=AllowedMessages" json:"AllowedMessages,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
}
