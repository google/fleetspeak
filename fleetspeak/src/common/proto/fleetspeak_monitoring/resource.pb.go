...
type AggregatedResourceUsage struct {
	...
	MaxIoReadMib       int32   `protobuf:"varint,8,opt,name=max_io_read_mib,json=maxIoReadMib,proto3" json:"max_io_read_mib,omitempty"`
	...
	MaxIoWriteMib      int32   `protobuf:"varint,10,opt,name=max_io_write_mib,json=maxIoWriteMib,proto3" json:"max_io_write_mib,omitempty"`
}
...
func (x *AggregatedResourceUsage) GetMaxIoReadMib() int32 {
	if x != nil {
...
func (x *AggregatedResourceUsage) GetMaxIoWriteMib() int32 {
	if x != nil {
...
var file_resource_proto_rawDesc = []byte{
	...
	0x6f, 0x5f, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x6d, 0x69, 0x62, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05,
	...
	0x01, 0x28, 0x05, 0x52, 0x0d, 0x6d, 0x61, 0x78, 0x49, 0x6f, 0x57, 0x72, 0x69, 0x74, 0x65, 0x4d,
