...
func (KillNotification_Reason) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 0} }
...
type KillNotification struct {
	...
	// Time when the process was started by Fleetspeak.
	ProcessStartTime *google_protobuf.Timestamp `protobuf:"bytes,4,opt,name=process_start_time,json=processStartTime" json:"process_start_time,omitempty"`
	// Time when the process was killed by Fleetspeak.
	KilledWhen *google_protobuf.Timestamp `protobuf:"bytes,5,opt,name=killed_when,json=killedWhen" json:"killed_when,omitempty"`
...
func (*KillNotification) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (m *KillNotification) GetProcessStartTime() *google_protobuf.Timestamp {
	if m != nil {
		return m.ProcessStartTime
	}
	return nil
...
func (m *KillNotification) GetKilledWhen() *google_protobuf.Timestamp {
	if m != nil {
		return m.KilledWhen
	}
	return nil
