...
const (
	...
	// In cases where the layer 7 load balancer that terminates the mTLS connection
	// also provides the client certificate checksum in and additional header
	// we want to cross check that checksum.
	// Use the HttpsConfig.client_certificate_header and also the
	// HttpsConfig.client_certificate_checksum_header below to set the names for
	// these headers.
	FrontendMode_HEADER_TLS_CHECKSUM FrontendMode = 2
)
...
var (
	FrontendMode_name = map[int32]string{
		0: "MTLS",
		1: "HEADER_TLS",
		2: "HEADER_TLS_CHECKSUM",
	}
	FrontendMode_value = map[string]int32{
		"MTLS":                0,
		"HEADER_TLS":          1,
		"HEADER_TLS_CHECKSUM": 2,
	}
)
...
type HttpsConfig struct {
	...
	// in this header.
	// This should be used if TLS is terminated at the load balancer and client
	// certificates can be passed upstream to the fleetspeak server as an http header.
	// Note for this parameter to take effect you also need to set the frontend_mode
	// and the client_certificate_header parameter accordingly.
	ClientCertificateChecksumHeader string `protobuf:"bytes,7,opt,name=client_certificate_checksum_header,json=clientCertificateChecksumHeader,proto3" json:"client_certificate_checksum_header,omitempty"`
}
...
var file_fleetspeak_src_server_components_proto_fleetspeak_components_config_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x65, 0x72, 0x22, 0xea, 0x02, 0x0a, 0x0b, 0x48, 0x74, 0x74, 0x70, 0x73, 0x43, 0x6f,
	...
	0x4d, 0x6f, 0x64, 0x65, 0x12, 0x4b, 0x0a, 0x22, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x63,
	0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b,
	0x73, 0x75, 0x6d, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x1f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63,
	0x61, 0x74, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x48, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x22, 0x34, 0x0a, 0x0b, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x27, 0x0a, 0x0b, 0x53, 0x74, 0x61, 0x74, 0x73,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	0x22, 0x3a, 0x0a, 0x11, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x43,
	...
	0x69, 0x73, 0x74, 0x65, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x2a, 0x41, 0x0a, 0x0c,
	0x46, 0x72, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x64, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x08, 0x0a, 0x04,
	0x4d, 0x54, 0x4c, 0x53, 0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x48, 0x45, 0x41, 0x44, 0x45, 0x52,
	0x5f, 0x54, 0x4c, 0x53, 0x10, 0x01, 0x12, 0x17, 0x0a, 0x13, 0x48, 0x45, 0x41, 0x44, 0x45, 0x52,
	0x5f, 0x54, 0x4c, 0x53, 0x5f, 0x43, 0x48, 0x45, 0x43, 0x4b, 0x53, 0x55, 0x4d, 0x10, 0x02, 0x42,
