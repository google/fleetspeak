...
func (x *FetchClientResourceUsageRecordsRequest) GetStartTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *FetchClientResourceUsageRecordsRequest) GetEndTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (c *adminClient) StreamClientIds(ctx context.Context, in *StreamClientIdsRequest, opts ...grpc.CallOption) (Admin_StreamClientIdsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Admin_serviceDesc.Streams[0], "/fleetspeak.server.Admin/StreamClientIds", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *adminClient) StreamClientContacts(ctx context.Context, in *StreamClientContactsRequest, opts ...grpc.CallOption) (Admin_StreamClientContactsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Admin_serviceDesc.Streams[1], "/fleetspeak.server.Admin/StreamClientContacts", opts...)
	if err != nil {
		return nil, err
	}
