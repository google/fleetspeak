...
type Client struct {
	...
	LastContactStreamingTo string                     `protobuf:"bytes,7,opt,name=last_contact_streaming_to,json=lastContactStreamingTo" json:"last_contact_streaming_to,omitempty"`
