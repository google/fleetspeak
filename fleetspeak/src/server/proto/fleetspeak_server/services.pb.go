...
func (*ServiceConfig) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func init() {
	proto.RegisterFile("fleetspeak/src/server/proto/fleetspeak_server/services.proto", fileDescriptor3)
}
