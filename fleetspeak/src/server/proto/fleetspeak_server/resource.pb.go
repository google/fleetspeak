...
type ClientResourceUsageRecord struct {
	...
	MeanIoReadKib         int64   `protobuf:"varint,13,opt,name=mean_io_read_kib,json=meanIoReadKib,proto3" json:"mean_io_read_kib,omitempty"`
	MaxIoReadKib          int64   `protobuf:"varint,14,opt,name=max_io_read_kib,json=maxIoReadKib,proto3" json:"max_io_read_kib,omitempty"`
	MeanIoWriteKib        int64   `protobuf:"varint,15,opt,name=mean_io_write_kib,json=meanIoWriteKib,proto3" json:"mean_io_write_kib,omitempty"`
	MaxIoWriteKib         int64   `protobuf:"varint,16,opt,name=max_io_write_kib,json=maxIoWriteKib,proto3" json:"max_io_write_kib,omitempty"`
}
...
func (x *ClientResourceUsageRecord) GetMeanIoReadKib() int64 {
	if x != nil {
...
func (x *ClientResourceUsageRecord) GetMeanIoWriteKib() int64 {
	if x != nil {
...
func (x *ClientResourceUsageRecord) GetMaxIoWriteKib() int64 {
	if x != nil {
...
var file_fleetspeak_src_server_proto_fleetspeak_server_resource_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x0d, 0x6d, 0x65, 0x61, 0x6e, 0x49, 0x6f, 0x52, 0x65, 0x61, 0x64, 0x4b, 0x69, 0x62,
	0x12, 0x25, 0x0a, 0x0f, 0x6d, 0x61, 0x78, 0x5f, 0x69, 0x6f, 0x5f, 0x72, 0x65, 0x61, 0x64, 0x5f,
	0x6b, 0x69, 0x62, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x6d, 0x61, 0x78, 0x49, 0x6f,
	...
	0x28, 0x03, 0x52, 0x0e, 0x6d, 0x65, 0x61, 0x6e, 0x49, 0x6f, 0x57, 0x72, 0x69, 0x74, 0x65, 0x4b,
	0x69, 0x62, 0x12, 0x27, 0x0a, 0x10, 0x6d, 0x61, 0x78, 0x5f, 0x69, 0x6f, 0x5f, 0x77, 0x72, 0x69,
	0x74, 0x65, 0x5f, 0x6b, 0x69, 0x62, 0x18, 0x10, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x6d, 0x61,
