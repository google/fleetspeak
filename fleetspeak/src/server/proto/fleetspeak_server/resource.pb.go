...
type ClientResourceUsageRecord struct {
	...
	MeanIoReadKib         int32   `protobuf:"varint,13,opt,name=mean_io_read_kib,json=meanIoReadKib,proto3" json:"mean_io_read_kib,omitempty"`
	MaxIoReadKib          int32   `protobuf:"varint,14,opt,name=max_io_read_kib,json=maxIoReadKib,proto3" json:"max_io_read_kib,omitempty"`
	MeanIoWriteKib        int32   `protobuf:"varint,15,opt,name=mean_io_write_kib,json=meanIoWriteKib,proto3" json:"mean_io_write_kib,omitempty"`
	MaxIoWriteKib         int32   `protobuf:"varint,16,opt,name=max_io_write_kib,json=maxIoWriteKib,proto3" json:"max_io_write_kib,omitempty"`
}
...
func (x *ClientResourceUsageRecord) GetMeanIoReadKib() int32 {
	if x != nil {
		return x.MeanIoReadKib
	}
	return 0
}

func (x *ClientResourceUsageRecord) GetMaxIoReadKib() int32 {
	if x != nil {
		return x.MaxIoReadKib
	}
	return 0
}

func (x *ClientResourceUsageRecord) GetMeanIoWriteKib() int32 {
	if x != nil {
		return x.MeanIoWriteKib
	}
	return 0
}

func (x *ClientResourceUsageRecord) GetMaxIoWriteKib() int32 {
	if x != nil {
		return x.MaxIoWriteKib
	}
	return 0
}
...
var file_fleetspeak_src_server_proto_fleetspeak_server_resource_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x96, 0x06, 0x0a, 0x19, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73,
	...
	,
}
