...
process_terminated BOOL NOT NULL,
...
mean_io_read_kib INT8,
max_io_read_kib INT8,
mean_io_write_kib INT8,
max_io_write_kib INT8,
FOREIGN KEY (client_id) REFERENCES clients(client_id))`,
		`CREATE TABLE IF NOT EXISTS messages(
message_id BINARY(32) NOT NULL,
source_client_id BINARY(8),
source_service_name VARCHAR(128) NOT NULL,
source_message_id VARBINARY(16) NULL,
