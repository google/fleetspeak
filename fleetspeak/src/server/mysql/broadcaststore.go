...
// DisableBroadcasts implements db.BroadcastStore. It disables the listed broadcasts and immediately deletes any
// active allocations while aggregating their stats to the parent broadcast totals.
