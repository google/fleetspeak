...
func (*Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_a6827971cd9d5d93, []int{0}
}
...
func init() {
	proto.RegisterFile("fleetspeak/src/server/grpcservice/proto/fleetspeak_grpcservice/grpcservice.proto", fileDescriptor_a6827971cd9d5d93)
}

var fileDescriptor_a6827971cd9d5d93 = []byte{
